									...
									<div class="post-outer">
										<div class="post-hentry">
											...
											<div class="entry-meta">
												...
												<span class="onDate">{$post.date_posted} | </span>
												<span class="onDate">{blog_getCommentsNumber({$post.id})} Comment(s)</span>
											</div>
		...
		<div class="widget-area" id="primary">
			...
			<div class="section" id="sidebar">
				<div class="widget HTML" id="HTML3">
					{if smarty_isAdminSession() } {include "bits/admin_box.tpl"} {else}
					{include "bits/admin_login.tpl"} {/if}
					<div class="clear"></div>
					<div class="clear"></div>
				</div>
						...
						<ul>
							<li>
								<div class="item-content">
									...
									<div class="item-snippet">Download this and more Blogger
										Templates at . For tutorials, tips and tricks about Blogger
										visit our Blog . &#187; A normal paragraph Ea eam lab...</div>
								</div>
								<div style="clear: both;"></div>
							</li>
						</ul>
							...
							<div id="BlogArchive1_ArchiveList">
								<ul class="hierarchy">
									<li class="archivedate expanded"><a class="toggle"
										href="javascript:void(0)"> <span class="zippy toggle-open">&#9660;&#160;</span>
										...
										<ul class="hierarchy">
											<li class="archivedate expanded"><a class="toggle"
												...
												title="August">August</a> <span class="post-count" dir="ltr">(4)</span>
												<ul class="posts">
													<li><a
														href="http://mantra-btemplates.blogspot.com/2011/08/lorem-ipsum_8310.html"
